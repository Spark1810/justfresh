...
def main():
    ...
    st.markdown("<h4 style='text-align: center; color: green;'>Harvesting Freshness, Delivering Quality: JustFresh - Your Online Marketplace for Locally Sourced, Premium Produce.</h4>", unsafe_allow_html=True)
    ...
    if choice == "HOME":
        ...
        st.subheader("JustFresh is more than an online fresh produce marketplace; it's a commitment to bringing the farm-fresh goodness right to your doorstep. Our platform connects you with local farmers and producers, ensuring that every bite is a celebration of flavor and nutrition. Immerse yourself in a world of vibrant fruits and crisp vegetables, carefully curated to meet the highest standards of freshness and quality. From the fertile fields to your kitchen, JustFresh guarantees the shortest journey for your groceries. Discover the joy of supporting local communities and sustainable agriculture while relishing the convenience of online shopping. Whether you're a health-conscious consumer, a culinary enthusiast, or someone who appreciates the simplicity of farm-to-table living, JustFresh is your go-to destination. With a diverse range of products, personalized recommendations, and a seamless checkout process, JustFresh redefines the way you experience and enjoy fresh produce. Join us in cultivating a healthier lifestyle, one fresh delivery at a time. Welcome to JustFresh, where freshness meets your doorstep with a click!")
